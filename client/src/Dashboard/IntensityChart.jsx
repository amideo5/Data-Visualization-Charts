...
const IntensityChart = ({ data }) => {
  const [selectedCountry, setSelectedCountry] = useState(''); // Initialize country filter state

  const countries = [...new Set(data.map(item => item.country))]; // Extract unique countries from data
  ...
  const intensityData = data
    .filter(item => !selectedCountry || item.country === selectedCountry) // Apply country filter
